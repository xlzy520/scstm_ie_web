<template>
  <div class="order-box">
      ...
      <div class="book">
        ...
        <div class="item-group" style="padding-bottom: 0">
          ...
          <ul class="numbers clearfix" v-if="numbers.length">
            ...
            >
              <Tooltip
                :content="[item.determine,item.qualified,item.is_stop] | tooltipMsg"
                placement="top"
              >
        ...
        <div class="item-group">
          <div class="group">
            ...
            <Form ref="formValidate" :model="formValidate">
              <FormItem v-for="(item,index) in formValidate.items" v-if="item.status" :key="index">
                <Row>
                  <Col span="5">
                    <FormItem
    ...
    <ShowPayEwm
      ...
      :money="number * details.data.money"
      :ewm="pay_ewm"
      @cancel="cancel"
    />
  </div>
...
export default {
  ...
  filters: {
    ...
    tooltipMsg([num1, num2, status]) {
      return status == 1
        ? num1 == num2
          ? "本场次预约人数已满，请选择其他场次试试看"
          : "本场次总共可预约" + num2 + "人，已预约" + num1 + "人"
        : "本场次预约时间已过";
    },
    residueMsg(num) {
      return num > 0
